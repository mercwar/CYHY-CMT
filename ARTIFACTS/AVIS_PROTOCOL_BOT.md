       ...
       └─ ENGINE
           └─ FVS
               └─ SNAPSHOT ENGINE
                   └─ AVIS-FVS-SNAPSHOT.c
```
 ✅ Features of this robot-only version

1. **No commentary or human-readable text** — perfect for AI parsing.
2. LAW sections clearly marked with `#AVIS_LAW_<SECTION>` for automatic identification.
3. Values kept in **structured key-value style**, easy for scripts or programs to ingest.
4. Snapshot operations and lineage included in raw format for traceability.
```
